...
PatternMonster::PatternMonster(Rectangle* patternRect, Graphics::Texture2D* texture) : Monster(new Vector2(patternRect->X, patternRect->Y), texture, new Graphics::Color(0.0,1.0,1.0))
{
	velocity->X = 1;
	velocity->Y = 0;
